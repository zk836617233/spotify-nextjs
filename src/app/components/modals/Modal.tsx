...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <>
      <div className="flex justify-between items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-black/70">
            ...
            <div className="translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
              ...
              <div className="flex items-center p-6 rounded-t justify-center border-b-[1px]">
                ...
                <button
                  ...
                  onClick={handleClose}
                >
                  <IoMdClose size={20} className="fill-gray-500" />
                </button>
              </div>
              {/* body */}
